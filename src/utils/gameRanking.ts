...
2. +5 points if a fav team wins.
3. +5 points the ame includes one of your fav teams.
4. -10 points if your fav team loses by more than 3 points. But only if the fav team is not playing againt another fav team.
5. +5 points in the game went to overtime.
6. +2 points in the game has over 50 hits.
7. +3 points in the game has over 70 hits.
8. +5 points if the game has over 100 hits.
9. +5 points if the game was within 1 goal, but didn't go to overtime.
10. +5 points in if the game has an empty net goal by a fav team.
11. +5 points if the game goes to overtime because of an empty net goal.
12. +5 points if the game has over 5 goals for each team.
13. +5 points if the game has over 30 shots for each team.
14. +5 points if the game has over 50 shots for a fav team.
15. +5 points if a team comes back by over 3 goals, but the team they beat is not a fav team.
16. +5 points if there was more than 2 fights in the game.
*/
